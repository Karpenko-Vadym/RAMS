...
{
    /// <summary>
    /// Database attributes configuration for CandidateArchive class
    /// </summary>
    public class CandidateArchiveConfiguration : EntityTypeConfiguration<CandidateArchive>
    {
        /// <summary>
        /// Default constructor that defines all the configurations
        /// </summary>
        public CandidateArchiveConfiguration()
        {
            ToTable("CandidateArchive"); // Select which table will be associated with CandidateArchive class
